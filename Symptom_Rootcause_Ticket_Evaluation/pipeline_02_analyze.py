...
SYMPTOMS = [
    {
        ...
        "root_causes": [
            "Not specified USB cable used to PC (above max. specified range) [HW]",
            "Loose micro-B USB interface (no cable clip used) [HW]",
    ...
    },
    {
        ...
        "root_causes": [
            ...
            "Loose USB3 remote/sensor interface [HW]",
            "More than one USB3 remote connected to acquisition PC [HW]",
    ...
    },
    {
        ...
        "root_causes": [
            ...
            "Incorrect torque used during sensor cable exchange [HW]",
    ...
    },
    {
        ...
        "root_causes": [
            ...
            "USB cable physically damaged [HW]",
            "Others currently unknown",
        ],
        "search_field": "notes",
        "keywords": [
    ...
    },
    {
        ...
        "root_causes": [
            ...
            "Acquisition software misconfiguration [SW]",
    ...
    },
    {
        ...
        "root_causes": [
            ...
            "Missing error handling in SW/FW [SW]",
            "Driver conflicts after IOSS/CDR reinstall [SW]",
            "Others currently unknown",
        ],
        "search_field": "notes",
        "keywords": [
